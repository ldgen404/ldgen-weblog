            ...
            <div
                ...
                <el-form class="w-5/6 md:w-2/5" ref="formRef" :rules="rules" :model="form">
                    <el-form-item prop="userAccount">
                        <!-- 输入框组件 -->
                        <el-input size="large" v-model="form.userAccount" placeholder="请输入用户名" :prefix-icon="User" clearable />
                    </el-form-item>
                    <el-form-item prop="password">
                        <!-- 密码框组件 -->
                        <el-input size="large" type="password" v-model="form.userPassword" placeholder="请输入密码"
                            :prefix-icon="Lock" clearable show-userPassword />
                    </el-form-item>
                    <el-form-item>
                        <!-- 登录按钮，宽度设置为 100% -->
...
const onSubmit = () => {
    ...
    formRef.value.validate((valid) => {
        ...
        // 调用登录接口
        login(form.userAccount, form.userPassword).then((res) => {
            console.log(res)
            // 判断是否成功
            if (res.code == 0) {
                // 提示登录成功
